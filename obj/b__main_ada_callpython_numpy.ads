...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_callpython_numpy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f9340369#;
   pragma Export (C, u00001, "main_ada_callpython_numpyB");
